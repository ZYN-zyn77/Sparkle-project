...
def upgrade():
    ...
    # Create table
    if not table_exists(inspector, "user_tool_history"):
        op.create_table(
            'user_tool_history',
    ...
    if not index_exists(inspector, "user_tool_history", "idx_user_tool_history_user_id"):
        op.create_index(
    ...
    if not index_exists(inspector, "user_tool_history", "idx_user_tool_history_tool_name"):
        op.create_index(
    ...
    if not index_exists(inspector, "user_tool_history", "idx_user_tool_history_success"):
        op.create_index(
    ...
    if not index_exists(inspector, "user_tool_history", "idx_user_tool_history_created_at"):
        op.create_index(
    ...
    if not index_exists(inspector, "user_tool_history", "idx_user_tool_history_user_created"):
        op.create_index(
    ...
    if not index_exists(inspector, "user_tool_history", "idx_user_tool_history_metrics"):
        op.create_index(
...
def downgrade():
    ...
    inspector = get_inspector()
    if table_exists(inspector, "user_tool_history"):
        if index_exists(inspector, "user_tool_history", "idx_user_tool_history_metrics"):
            op.drop_index('idx_user_tool_history_metrics')
        if index_exists(inspector, "user_tool_history", "idx_user_tool_history_user_created"):
            op.drop_index('idx_user_tool_history_user_created')
        if index_exists(inspector, "user_tool_history", "idx_user_tool_history_created_at"):
            op.drop_index('idx_user_tool_history_created_at')
        if index_exists(inspector, "user_tool_history", "idx_user_tool_history_success"):
            op.drop_index('idx_user_tool_history_success')
        if index_exists(inspector, "user_tool_history", "idx_user_tool_history_tool_name"):
            op.drop_index('idx_user_tool_history_tool_name')
        if index_exists(inspector, "user_tool_history", "idx_user_tool_history_user_id"):
