...
def upgrade() -> None:
    ...
    existing_tables = [table for table in inspector.get_table_names(schema="public") if table != "alembic_version"]
    if existing_tables:
        # Assume initial schema already applied; avoid duplicate table/index errors on re-run.
        return
