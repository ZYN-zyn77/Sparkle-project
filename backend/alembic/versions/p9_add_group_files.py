...
def upgrade():
    ...
    if not table_exists(inspector, "group_files"):
        op.create_table(
            ...
            sa.Column('view_role', sa.Enum('OWNER', 'ADMIN', 'MEMBER', name='grouprole', create_type=False), nullable=False),
            sa.Column('download_role', sa.Enum('OWNER', 'ADMIN', 'MEMBER', name='grouprole', create_type=False), nullable=False),
            sa.Column('manage_role', sa.Enum('OWNER', 'ADMIN', 'MEMBER', name='grouprole', create_type=False), nullable=False),
