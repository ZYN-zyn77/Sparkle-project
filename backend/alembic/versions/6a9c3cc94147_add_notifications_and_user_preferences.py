...
def upgrade() -> None:
    ...
    # op.add_column('chat_messages', sa.Column('message_id', sa.String(length=36), nullable=True))
    # op.add_column('chat_messages', sa.Column('parse_degraded', sa.Boolean(), nullable=True))
    # op.drop_index(op.f('idx_chat_deleted_at'), table_name='chat_messages')
    # op.create_index(op.f('ix_chat_messages_deleted_at'), 'chat_messages', ['deleted_at'], unique=False)
    # op.create_unique_constraint(None, 'chat_messages', ['message_id'])
