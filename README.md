...
**按角色查找：**
- **后端开发者**：从 [技术架构](docs/00_项目概览/02_技术架构.md) → [模块总览](docs/01_核心模块文档/01_模块总览.md) → [API参考](docs/02_技术设计文档/03_API参考.md)
- **前端开发者**：从 [技术架构](docs/00_项目概览/02_技术架构.md) → [UI重构计划](docs/04_功能实现指南/03_UI重构计划.md) → [社群实现指南](docs/04_功能实现指南/01_社群功能实现指南.md)
- **全栈开发者**：从 [项目总览](docs/00_项目概览/01_项目总览.md) → [模块总览](docs/01_核心模块文档/01_模块总览.md) → [知识星图设计](docs/02_技术设计文档/02_知识星图系统设计_v3.0.md)
- **项目经理**：从 [项目总览](docs/00_项目概览/01_项目总览.md) → [计划概览](docs/04_功能实现指南/06_计划概览.md) → [项目历史](docs/05_项目历史与里程碑/)

### 📁 原始文档（部分已迁移）

以下是一些原始文档，部分已迁移到新版文档结构中：
...
> **注意**：建议优先使用新版文档结构（docs/目录下），原始文档将逐步迁移完成。
