  ...
  group('Galaxy Integration Tests', () {
    group('Layout Engine + QuadTree Integration', () {
      ...
      test('quad tree accelerates neighbor queries', () {
        ...
        final neighbors = tree.queryCircle(Offset.zero, 500);
        stopwatch.stop();
    ...
    group('End-to-End Data Flow', () {
      test('complete data flow from nodes to positions', () async {
        ...
        final visibleNodes = culler.filterVisibleNodes(nodes, optimizedPositions);
        final visibleEdges = culler.filterVisibleEdges(edges, optimizedPositions);
