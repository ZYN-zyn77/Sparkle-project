            ...
            Positioned.fill(
              child: AnimatedBuilder(
                ...
                builder: (context, child) => CustomPaint(
                  painter:
                      _SectorModelPainter(animationValue: _controller.value),
                ),
              ),
            ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: DS.brandPrimary
                          .withValues(alpha: 0.9), // Wisdom (White)
                      boxShadow: [
                        BoxShadow(
                    ...
                    child: Center(
                      child: Icon(Icons.psychology,
                          size: 40, color: DS.brandPrimary87,),
                    ),
                  ),
            ...
            Positioned(
              ...
              child: InteractiveDecayTimeline(
                ...
                onSimulateIntervention: (nodeIds, days) {
                  ...
                  if (kDebugMode) {
                    debugPrint('模拟复习 ${nodeIds.length} 个节点');
                  }
                },
              ),
            ),
...
class _SectorModelPainter extends CustomPainter {
  ...
  static final List<_SectorDef> sectors = [
    ...
    _SectorDef(
      ...
      name: '造物星域',
      color:
          const Color(0xFFC0C0C0), // Silver (Using light grey for visibility)
      icon: Icons.computer,
      description: '创造与工具',
    ),
    _SectorDef(
  ...
  void _drawSector(
    ...
    canvas.drawCircle(
      ...
      25,
      Paint()
        ..color = sector.color.withValues(alpha: 0.2)
    ...
    textPainter.paint(
      canvas,
      Offset(iconPos.dx - textPainter.width / 2,
    ...
    for (var i = 0; i < 8; i++) {
      ...
      final a = startAngle +
          (random.nextDouble() * 0.8 + 0.1) *
              sweepAngle; // Keep away from edges
