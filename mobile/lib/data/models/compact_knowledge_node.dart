...
class CompactKnowledgeNode {
  ...
  factory CompactKnowledgeNode.create({
    ...
    if (resolvedSectorIndex == null) {
      throw ArgumentError('sectorIndex or subjectId must be provided.');
    }
    // 1. Hash ID
    ...
    // 2. Position
    final position = Float32List.fromList([x, y]);
    ...
    packed |= (resolvedSectorIndex & 0x3F) << 10;
  ...
  CompactKnowledgeNode copyWith({
    ...
    if (position != null) {
      ...
      newPosition = Float32List.fromList(position);
    }
