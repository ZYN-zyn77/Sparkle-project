...
/// Galaxy监控集成Provider
final galaxyMonitoringProvider = Provider.autoDispose<GalaxyMonitoringIntegration>((ref) {
      ...
      child: Column(
        ...
        children: [
          ...
          if (summary.recommendations.isNotEmpty) ...[
            ...
            const SizedBox(height: 4),
            ...summary.recommendations.map((r) => Padding(
          ...
          if (_recentWarnings.isNotEmpty) ...[
            ...
            const SizedBox(height: 4),
            ...(_recentWarnings.take(5).map((w) => Padding(
              padding: const EdgeInsets.only(top: 2),
              child: Row(
                children: [
                  Icon(
