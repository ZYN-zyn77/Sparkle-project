...
class SparkleAnimatedScale extends ImplicitlyAnimatedWidget {
  ...
  @override
  ImplicitlyAnimatedWidgetState<SparkleAnimatedScale> createState() =>
      _SparkleAnimatedScaleState();
}

class _SparkleAnimatedScaleState
    extends ImplicitlyAnimatedWidgetState<SparkleAnimatedScale> {
