...
class ChatRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChatRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'agent.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1.Struct>(5, _omitFieldNames ? '' : 'extraContext', subBuilder: $1.Struct.create)
  ...
  @$pb.TagNumber(5)
  set extraContext($1.Struct v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class ToolResultPayload extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ToolResultPayload', package: const $pb.PackageName(_omitMessageNames ? '' : 'agent.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1.Struct>(3, _omitFieldNames ? '' : 'data', subBuilder: $1.Struct.create)
    ..aOS(4, _omitFieldNames ? '' : 'errorMessage')
    ..aOS(5, _omitFieldNames ? '' : 'suggestion')
    ..aOS(6, _omitFieldNames ? '' : 'widgetType')
    ..aOM<$1.Struct>(7, _omitFieldNames ? '' : 'widgetData', subBuilder: $1.Struct.create)
  ...
  @$pb.TagNumber(3)
  set data($1.Struct v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(7)
  set widgetData($1.Struct v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class InterventionRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InterventionRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'agent.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1.Struct>(14, _omitFieldNames ? '' : 'content', subBuilder: $1.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(14)
  set content($1.Struct v) { setField(14, v); }
  @$pb.TagNumber(14)
...
class AgentServiceApi {
  ...
  $async.Future<ChatResponse> streamChat($pb.ClientContext? ctx, ChatRequest request) =>
    _client.invoke<ChatResponse>(ctx, 'AgentService', 'StreamChat', request, ChatResponse())
  ;
  $async.Future<MemoryResult> retrieveMemory($pb.ClientContext? ctx, MemoryQuery request) =>
    _client.invoke<MemoryResult>(ctx, 'AgentService', 'RetrieveMemory', request, MemoryResult())
  ;
  $async.Future<UserProfile> getUserProfile($pb.ClientContext? ctx, ProfileRequest request) =>
    _client.invoke<UserProfile>(ctx, 'AgentService', 'GetUserProfile', request, UserProfile())
  ;
  $async.Future<WeeklyReport> getWeeklyReport($pb.ClientContext? ctx, WeeklyReportRequest request) =>
    _client.invoke<WeeklyReport>(ctx, 'AgentService', 'GetWeeklyReport', request, WeeklyReport())
  ;
}
