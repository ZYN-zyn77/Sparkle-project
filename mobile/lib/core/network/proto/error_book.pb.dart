...
class ErrorRecord extends $pb.GeneratedMessage {
  factory ErrorRecord({
    ...
    $2.Timestamp? nextReviewAt,
    $2.Timestamp? lastReviewedAt,
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ErrorRecord', package: const $pb.PackageName(_omitMessageNames ? '' : 'error_book'), createEmptyInstance: create)
    ...
    ..aOM<$2.Timestamp>(11, _omitFieldNames ? '' : 'nextReviewAt', subBuilder: $2.Timestamp.create)
    ..aOM<$2.Timestamp>(12, _omitFieldNames ? '' : 'lastReviewedAt', subBuilder: $2.Timestamp.create)
    ...
    ..aOM<$2.Timestamp>(16, _omitFieldNames ? '' : 'updatedAt', subBuilder: $2.Timestamp.create)
  ...
  @$pb.TagNumber(11)
  $2.Timestamp get nextReviewAt => $_getN(10);
  @$pb.TagNumber(11)
  set nextReviewAt($2.Timestamp v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasNextReviewAt() => $_has(10);
  @$pb.TagNumber(11)
  void clearNextReviewAt() => clearField(11);
  @$pb.TagNumber(11)
  $2.Timestamp ensureNextReviewAt() => $_ensure(10);

  @$pb.TagNumber(12)
  $2.Timestamp get lastReviewedAt => $_getN(11);
  @$pb.TagNumber(12)
  set lastReviewedAt($2.Timestamp v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasLastReviewedAt() => $_has(11);
  @$pb.TagNumber(12)
  void clearLastReviewedAt() => clearField(12);
  @$pb.TagNumber(12)
  $2.Timestamp ensureLastReviewedAt() => $_ensure(11);
  ...
  @$pb.TagNumber(16)
  set updatedAt($2.Timestamp v) { setField(16, v); }
  @$pb.TagNumber(16)
...
class ErrorBookServiceApi {
  $pb.RpcClient _client;
  ErrorBookServiceApi(this._client);

  $async.Future<ErrorRecord> createError($pb.ClientContext? ctx, CreateErrorRequest request) =>
    _client.invoke<ErrorRecord>(ctx, 'ErrorBookService', 'CreateError', request, ErrorRecord())
  ;
  $async.Future<ListErrorsResponse> listErrors($pb.ClientContext? ctx, ListErrorsRequest request) =>
    _client.invoke<ListErrorsResponse>(ctx, 'ErrorBookService', 'ListErrors', request, ListErrorsResponse())
  ;
  $async.Future<ErrorRecord> getError($pb.ClientContext? ctx, GetErrorRequest request) =>
    _client.invoke<ErrorRecord>(ctx, 'ErrorBookService', 'GetError', request, ErrorRecord())
  ;
  $async.Future<ErrorRecord> updateError($pb.ClientContext? ctx, UpdateErrorRequest request) =>
    _client.invoke<ErrorRecord>(ctx, 'ErrorBookService', 'UpdateError', request, ErrorRecord())
  ;
  $async.Future<DeleteErrorResponse> deleteError($pb.ClientContext? ctx, DeleteErrorRequest request) =>
    _client.invoke<DeleteErrorResponse>(ctx, 'ErrorBookService', 'DeleteError', request, DeleteErrorResponse())
  ;
  $async.Future<AnalyzeErrorResponse> analyzeError($pb.ClientContext? ctx, AnalyzeErrorRequest request) =>
    _client.invoke<AnalyzeErrorResponse>(ctx, 'ErrorBookService', 'AnalyzeError', request, AnalyzeErrorResponse())
  ;
  $async.Future<ErrorRecord> submitReview($pb.ClientContext? ctx, SubmitReviewRequest request) =>
    _client.invoke<ErrorRecord>(ctx, 'ErrorBookService', 'SubmitReview', request, ErrorRecord())
  ;
  $async.Future<ReviewStatsResponse> getReviewStats($pb.ClientContext? ctx, GetReviewStatsRequest request) =>
    _client.invoke<ReviewStatsResponse>(ctx, 'ErrorBookService', 'GetReviewStats', request, ReviewStatsResponse())
  ;
  $async.Future<ListErrorsResponse> getTodayReviews($pb.ClientContext? ctx, GetTodayReviewsRequest request) =>
    _client.invoke<ListErrorsResponse>(ctx, 'ErrorBookService', 'GetTodayReviews', request, ListErrorsResponse())
  ;
}
