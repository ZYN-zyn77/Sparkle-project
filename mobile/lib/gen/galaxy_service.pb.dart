...
class UpdateNodeMasteryRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'UpdateNodeMasteryRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'galaxy.v1'), createEmptyInstance: create)
    ...
    ..aOM<$5.Timestamp>(4, _omitFieldNames ? '' : 'version', subBuilder: $5.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  $5.Timestamp get version => $_getN(3);
  @$pb.TagNumber(4)
  set version($5.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasVersion() => $_has(3);
  @$pb.TagNumber(4)
  void clearVersion() => clearField(4);
  @$pb.TagNumber(4)
  $5.Timestamp ensureVersion() => $_ensure(3);
