...
class _ReflectionDialogState extends ConsumerState<ReflectionDialog> {
  ...
  Future<void> _submit() async {
    ...
    try {
      final content = 'Focus Session Reflection: I felt $_feeling.\n${_noteController.text}';
  ...
  Widget build(BuildContext context) => AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: ['🔥 心流', '🙂 专注', '😐 一般', '😖 分心', '😫 疲惫'].map((f) => 
              ChoiceChip(
                label: Text(f),
                selected: _feeling == f,
                onSelected: (b) => setState(() => _feeling = b ? f : null),
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: TextStyle(color: DS.brandPrimary.withOpacity(0.5)),
              enabledBorder: OutlineInputBorder(
                borderSide: BorderSide(color: DS.brandPrimary.withOpacity(0.3)),
      ...
      actions: [
        TextButton(
          ...
          child: Text('跳过', style: TextStyle(color: DS.brandPrimary.withOpacity(0.6))),
        ),
        ElevatedButton(
